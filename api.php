...
// Get DB credentials from basic auth if provided, else fallback hardcoded
$defaultDbHost = 'localhost';
$defaultDbPort = '3306';
$defaultDbName = 'conference_rooms';
$defaultDbUser = 'conf_user';
$defaultDbPass = 'JHSdfuy45klaye45';

// Allow optional override via query/post parameters for health checks or manual tests
$dbHost = $_REQUEST['db_host'] ?? $defaultDbHost;
$dbPort = $_REQUEST['db_port'] ?? $defaultDbPort;
$dbName = $_REQUEST['db_name'] ?? $defaultDbName;
$dbUser = $_REQUEST['db_user'] ?? $defaultDbUser;
$dbPass = $_REQUEST['db_pass'] ?? $defaultDbPass;
